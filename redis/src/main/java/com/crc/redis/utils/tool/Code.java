package com.crc.redis.utils.tool;
 ...
 * @Author CRC
 * @Date 2020/6/3
 * @Describe 参考：https://www.cnblogs.com/houzheng/p/11170714.html
 */
public class Code {
    /**
     * <p>
...
//        gc.setOutputDir(projectPath + "/mybatisplus/src/main/java"); //生成文件输出目录
        gc.setOutputDir(projectPath + "\\mybatis-pluc-tool\\src\\main\\java"); //生成文件输出目录
        gc.setAuthor("侯征");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pachong?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
